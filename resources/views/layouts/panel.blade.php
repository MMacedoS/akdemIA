                ...
                $navigationItems = match ($role) {
                    \App\Enums\Role::ADMIN => [
                        ...
                        ...((bool) auth()->user()?->isSystemAdmin() ? [
                            ...
                            ['label' => 'Catalogos', 'icon' => 'CT', 'route' => 'system-admin.workouts.catalogs.index', 'active' => 'system-admin.workouts.catalogs.*'],
                            ...
                            ['label' => 'Google Auth', 'icon' => 'GA', 'route' => 'system-admin.settings.google-auth.edit', 'active' => 'system-admin.settings.google-auth.*'],
