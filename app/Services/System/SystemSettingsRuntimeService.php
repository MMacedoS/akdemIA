...
class SystemSettingsRuntimeService
{
    public function apply(): void
    {
        ...
        config([
            ...
            'services.payment.provider_name' => $this->stringOrNull($settings->get('payment.provider_name')) ?: config('services.payment.provider_name'),
            ...
            'services.payment.stripe_secret' => $this->stringOrNull($settings->get('payment.stripe_secret')) ?: config('services.payment.stripe_secret'),
            'services.payment.stripe_webhook_secret' => $this->stringOrNull($settings->get('payment.stripe_webhook_secret')) ?: config('services.payment.stripe_webhook_secret'),
            'services.pix.key' => $this->stringOrNull($settings->get('payment.pix_key')) ?: config('services.pix.key'),
            'services.stripe.secret' => $this->stringOrNull($settings->get('payment.stripe_secret')) ?: config('services.stripe.secret'),
            'services.stripe.webhook_secret' => $this->stringOrNull($settings->get('payment.stripe_webhook_secret')) ?: config('services.stripe.webhook_secret'),
