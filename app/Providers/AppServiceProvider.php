...
use App\Repositories\Entities\SystemAdmin\GoogleAuthSettingsRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(GoogleAuthSettingsRepositoryContract::class, GoogleAuthSettingsRepository::class);
